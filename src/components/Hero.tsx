    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-gradient-to-br from-base to-base-dark">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <button className="w-full sm:w-auto bg-primary text-white px-10 py-4 rounded-2xl text-base font-bold shadow-xl shadow-primary/20 hover:bg-primary-dark transition-all hover:-translate-y-1 flex items-center justify-center gap-2">
              {t.explore}
              <ArrowRight size={20} />
            </button>
            <button className="w-full sm:w-auto px-10 py-4 rounded-2xl text-base font-bold text-primary border-2 border-primary hover:bg-white/50 transition-all">
              {t.merit}
            </button>
          </motion.div>
