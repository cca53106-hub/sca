...
import { Bot, X, Send, Terminal, AlertTriangle, Sparkles, MessageSquare } from 'lucide-react';
    ...
    <div className="fixed bottom-6 right-6 z-[60]">
      ...
      >
        ...
        <div className="relative z-10">
          {isOpen ? <X size={28} /> : (
            <div className="relative">
              <MessageSquare size={28} className="group-hover:text-primary-dark transition-colors" />
