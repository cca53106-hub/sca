        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {t.courses.map((course, i) => (
            ...
            >
              ...
              <div className="h-1.5 w-12 group-hover:w-full bg-primary/20 transition-all duration-500 rounded-full relative overflow-hidden">
        ...
        <div className="mt-20 text-center">
          <div className="inline-block p-1.5 bg-border rounded-full shadow-inner">
            <div className="bg-white px-8 py-3 rounded-full shadow-sm text-sm font-bold text-text-light flex items-center gap-2">
              {t.matric} <span className="text-primary hover:underline cursor-pointer">{t.consult}</span>
            </div>
          </div>
        </div>
      </div>
